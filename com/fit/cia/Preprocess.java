...
import com.fit.cia.algorithm.WaveAlgorithm;
...
public class Preprocess {
	public static void main(String[] args) {
		...
		/** Test wave algorithm */
		List<Node> leafNode = Search.searchNode(projectRootNode, new WaveLeafCondition());
		WaveAlgorithm wave = new WaveAlgorithm(leafNode, Utils.createRandomChangeSet(leafNode, 8));
