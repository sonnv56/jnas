...
/**
 * Xuat cay cau truc sang dang JSON: cay cau truc chua day du cau truc project
 * 
 * @author Duc Anh
 *
 */
public class JsonStrategy2 implements IToString {
	 ...
	 *            root cua project
	 */
	public JsonStrategy2(Node node) {
		this.node_ = node;
		convertToString();
	}
